...
const deletePost = id =>
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a
        .delete(`${__WEBPACK_IMPORTED_MODULE_2__config__["a" /* apiBase */]}/blog/${id}`, {
...
const loadComments = id => {
    let uri = `${__WEBPACK_IMPORTED_MODULE_1__config__["a" /* apiBase */]}/blog/${id}/comments`;
    if (nextPage) {
        uri += `?start=${nextPage}`;
    }
    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
...
const submitComment = (e, id) => {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
        .post(`${__WEBPACK_IMPORTED_MODULE_1__config__["a" /* apiBase */]}/blog/${blogPostId}/comments`, postData)
        .then(response => {
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.ebcadacfa3708b0b731a.js.map