...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(1), __webpack_require__(11), __webpack_require__(40));
...
/* harmony export (immutable) */ __webpack_exports__["a"] = API_BASE;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_es6_docready__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_main_scss__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_simplemde__ = __webpack_require__(36);
...
const deletePost = id =>
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a
    .delete(`${__WEBPACK_IMPORTED_MODULE_2__config__["a" /* API_BASE */]}/blog/${id}`, {
...
var CodeMirrorSpellChecker = __webpack_require__(44);
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(1), __webpack_require__(10), __webpack_require__(12));
  else if (typeof define == "function" && define.amd) // AMD
...
// Requires
var Typo = __webpack_require__(45);
...
const deleteComment = e => {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
    .delete(`${__WEBPACK_IMPORTED_MODULE_1__config__["a" /* API_BASE */]}/comments/${id}`)
    .then(() => {
...
const loadComments = id => {
  let uri = `${__WEBPACK_IMPORTED_MODULE_1__config__["a" /* API_BASE */]}/blog/${id}/comments`;
  if (nextPage) {
    uri += `?start=${nextPage}`;
  }
  return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
...
const submitComment = (e, id) => {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
    .post(`${__WEBPACK_IMPORTED_MODULE_1__config__["a" /* API_BASE */]}/blog/${blogPostId}/comments`, postData)
    .then(response => {
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.86291f8e351b4a560f75.js.map